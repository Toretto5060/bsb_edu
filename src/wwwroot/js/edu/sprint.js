    ...
    switch (params) {
        case "zk":
            ...
            if (window.location.href.indexOf("webAddress") > 0) {
                ...
                ajaxGetInformation('get', '/video', { is_middle_school_sprint: 1, subject_id: hasBeenSe + 1, page: currentPa, is_sprint: 1}, 0);
            } else {
                ajaxGetInformation('get', '/video', { is_middle_school_sprint: 1, subject_id: 1, is_sprint: 1});
            }
        ...
        case "gk":
            ...
            if (window.location.href.indexOf("webAddress") > 0) {
                var locateParams = window.location.href.split("webAddress=")[1],
                    hasBeenSe = Number(locateParams.split("&")[0]),
                    currentPa = Number(locateParams.split("&")[2]);
                ajaxGetInformation('get', '/video', { is_high_school_sprint: 1, subject_id: hasBeenSe + 1, page: currentPa, is_sprint: 1}, 0);
            } else {
                ajaxGetInformation('get', '/video', { is_high_school_sprint: 1, subject_id: 1, is_sprint: 1});
            }
